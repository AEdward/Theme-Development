 ...
 *
 * @uses ocean_wp_child_by_anahom_header_style()
 */
...
add_action( 'after_setup_theme', 'ocean_wp_child_by_anahom_custom_header_setup' );

if ( ! function_exists( 'ocean_wp_child_by_anahom_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see ocean_wp_child_by_anahom_custom_header_setup().
	 */
	function ocean_wp_child_by_anahom_header_style() {
