...
if ( ! function_exists( 'ocean_wp_child_by_anahom_setup' ) ) :
	 ...
	 */
	function ocean_wp_child_by_anahom_setup() {
		/*
		...
		add_theme_support( 'custom-background', apply_filters( 'ocean_wp_child_by_anahom_custom_background_args', array(
...
add_action( 'after_setup_theme', 'ocean_wp_child_by_anahom_setup' );



function ocean_wp_child_by_anahom_add_editor_style(){

add_editor_style('dist/css/editor-style.css');

}
add_action('admin_init', 'ocean_wp_child_by_anahom_add_editor_style');
 ...
 */
function ocean_wp_child_by_anahom_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'ocean_wp_child_by_anahom_content_width', 1140 );
}
